...
description: Technical implementation of OAuth-based team and user separation in DeployStack Satellite for per-user MCP server instance access control.
---
...
- **user_id**: Database UUID for user identification

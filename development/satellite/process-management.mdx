...
description: Technical implementation of per-user stdio subprocess management for local MCP servers in DeployStack Satellite.
---
...
- Process 1: filesystem-acme-alice-abc123 (Alice's instance)
- Process 2: filesystem-acme-bob-abc123 (Bob's instance)
- Process 3: filesystem-acme-charlie-abc123 (Charlie's instance)

Each process runs independently with user-specific configuration.
```
...
### Backend Filtering (awaiting_user_config)

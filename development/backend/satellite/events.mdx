...
**Required Fields** (snake_case): `installation_id`, `team_id`, `user_id`, `status`, `timestamp`
...
| `mcp.server.status_changed` | `mcpServerInstances` | Update status, status_message, status_updated_at for specific user's instance |

...
For a complete explanation of how MCP categories work, see the [MCP Categories Guide](/mcp-categories).
...
For detailed security information about configuration handling, see [MCP Configuration System](/mcp-configuration).

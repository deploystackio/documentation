...
<Steps>
  <Step title="Create DeployStack Account">
...
Read more about Roles: [Team Roles](/general/roles)
...
<Steps>
  <Step title="Accept Team Invitation">
  ...
  <Step title="Update MCP Configuration">

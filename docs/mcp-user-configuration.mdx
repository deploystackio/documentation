...
**Adding a New Device:**
1. **Automatic Detection** - System identifies this as a new device during login
2. **Secure Registration** - Device is registered through OAuth2 authentication
3. **Device Naming** - System uses hostname by default, you can customize
4. **Configuration Setup** - Configure personal settings for this device
5. **Team Inheritance** - Automatically inherit all team settings

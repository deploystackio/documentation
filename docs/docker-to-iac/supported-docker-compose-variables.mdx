---
title: Supported Docker Compose Variables
...
| Property | Description | Example |
|----------|-------------|----------|
| `ports` | List of ports to expose. Supports port mapping in standard Docker format. | ports:  - "8080:80":   - "443:443" |
...
| `volumes` | List of volume mappings. | `volumes:`: `  - "data:/var/lib/mysql"`: `  - "./config:/etc/nginx/conf.d:ro"` |
| `environment` | Environment variables as key-value pairs. | `environment:`: `  NODE_ENV: production`: `  PORT: 3000` |

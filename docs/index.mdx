...
<Cards>
  ...
  >
    Get started with DeployStack in minutes. Set up your first MCP server and connect to the DeployStack Gateway.
  </Card>
...
<Cards>
  ...
  >
    Build and extend the DeployStack Gateway for secure MCP server management
  </Card>
</Cards>

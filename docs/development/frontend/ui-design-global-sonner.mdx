...
Combine Sonner with the [i18n system](/deploystack/development/frontend/internationalization) for localized messages:
...
Sonner works seamlessly with the [global event bus](/deploystack/development/frontend/event-bus):

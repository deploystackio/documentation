...
- **Client Validation:** Dynamic client registration for MCP clients with validation against allowed patterns
...
- `@fastify/swagger`: JSON Schema validation and API documentation
